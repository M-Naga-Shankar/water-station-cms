...
?>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Total Tins</div>
                                    <div class="stat-digit"> <i class="fa fa-database"></i><?php 
                                                $quantity=0;
        ...
        echo $j['count'];
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Out Tins</div>
                                    <div class="stat-digit"> <i class="fa fa-database"></i> <?php 
                                                $quantity=0;
                                                $sql2 = mysqli_query($conn, "select * from log ");
    while ($j = mysqli_fetch_array($sql2)) {
